...
(function () {
  ...
  window.LSAPI = {
    ...
    getActivity: function (orgId, limit, offset) {
      return req("GET", "/orgs/" + orgId + "/activity?limit=" + (limit || 20) + "&offset=" + (offset || 0))
        .then(function (r) { return { rows: mapActivity(r, null), total: (r && r.total) || 0 }; });
    },
